 ...
 * @param {string} [description] - optional supporting copy below the underline
 * @param {'left'|'center'} [align]
 */
export default function SectionHeader({ eyebrow, title, accent, description, align = 'left', className }) {
  return (
